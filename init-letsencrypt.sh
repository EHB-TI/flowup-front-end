...
domains=(desiderius.be www.desiderius.be)
rsa_key_size=4096
data_path="./data/certbot"
email="flowup.dhb@gmail.com" # Adding a valid address is strongly recommended
...
# cp home/frontend/secrets/.env ./ip2-frontend/.env
